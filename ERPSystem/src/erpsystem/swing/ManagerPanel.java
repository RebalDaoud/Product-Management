package erpsystem.swing;

import erpsystem.I.O.ErrorLogger;
import erpsystem.I.O.ErrorsReader;
import erpsystem.FactoryController;
import erpsystem.Mission;
...
import erpsystem.AllException;
import erpsystem.LineState;
import erpsystem.ProductLine;
...
//constructor
    public ManagerPanel(FactoryController controller) throws AllException.ProductLineNotFoundException {
    ...
    private JPanel createLinesPanel() throws AllException.ProductLineNotFoundException {
        JPanel panel = new JPanel(new BorderLayout());
        panel.setBackground(new Color(31, 31, 46));
