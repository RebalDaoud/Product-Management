...
public class SupervisorPanel extends JPanel {
    ...
    private void loadMissionsData() {
        ...
        List<erpsystem.Mission> missions = FactoryController.getInstance().getAllMissions();

        for (erpsystem.Mission m : missions) {
            Object[] row = {
                m.getMissionId(),
        ...
        btnStart.addActionListener(e -> {
            try {
                ...
                if (selectedLineIndex == -1) {
                    throw new Exception("Please select a product line!");
                }
        ...
        btnGenerate.addActionListener(e -> {
            ...
            try {
                if (rdoPerformance.isSelected()) {
                    ...
                    if (levels.isEmpty()) {
                        sb.append("No active product lines found.\n");
                    }
                    ...
                    if (!foundAny) {
                        sb.append("No products have been finished yet.\n");
                    }
