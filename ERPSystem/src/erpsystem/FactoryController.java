...
import erpsystem.I.O.InventoryWriter;
import erpsystem.I.O.MissionHistoryWriter;
...
//constructor
    ...
    public void assignMissionToLine(int missionId, int lineId) {
        ...
        if (mission != null && selectedLine != null) {
    ...
    //Inventory status tracking intermediary
